        ...
        <div className="container">
            ...
            <main className="content">
                ...
                <section id="introduction">
                    <h2>Introduction</h2>
                    <p>CannaMint Token Creator is the fastest and most secure way to launch a token on Base. Our platform offers the simplest method to create Base ERC-20
                        tokens with no coding required. Mint tokens instantly with audited Solidity contract libraries and remove all technical aspects of token creation.
                        All these best-in-class features are included in your generated token.</p>
                    <p>CannaMint stands out as the most affordable platform for token creation on Base. We go beyond just token generation by providing free additional
                        services such as setting up a liquidity pool (coming soon), ensuring a comprehensive launch experience for your project.</p>
                </section>

                <section id="connecting-wallet">
                    <h2>Connecting Wallet</h2>
                    <p>CannaMint offers unparalleled wallet compatibility for the Base network which enables as many people as possible to launch their own token. Our
                ...
                <section id="create-token">
                    ...
                    <p>Creating your Base ERC-20 token with CannaMint only takes 10 seconds! Our intuitive user-friendly interface guides you through each step, from defining
                        your token's basic parameters to implementing advanced features. No coding knowledge is required – we've simplified the entire process so you can
                        focus on your token's unique properties and use case.</p>
                </section>
                ...
                <section id="token-management">
                    ...
                    <p>After creating your token, CannaMint offers robust management tools and video tutorials. Monitor your token's performance, manage liquidity pools, and implement token
                        burns or mints as needed. Our platform provides ongoing support to ensure your Base ERC-20 token continues to meet your project's evolving needs. </p>
                </section>
